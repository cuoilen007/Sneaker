...
<?php
                        ...
                        where id_process = 4 '.$additional.' ORDER BY id DESC limit '.$firstIndex.','.$limit; 
						$orderList = executeResult($sql);
						//dem so trang
						$sql='select count(id) as total from orders where id_process = 4 '.$additional;
