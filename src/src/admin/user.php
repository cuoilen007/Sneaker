                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <p class="card-description">
                        Admin  <code>.Users Page</code>
                      </p>            
                    </div>
                    <div class="col-lg-6">
                          <form method="get">
                            <div class="form-group" style="width: 200px; float: right;">
                              <input type="text" class="form-control" placeholder="Search user..." id="n" name="n">
                            </div>
                          </form>            
                    </div>  
                  </div>
...
foreach($userList as $item){
  ...
  echo'
                        ...
                        <tr>
                          ...
                          <td>'.$item['login'].'</td>
                          <td>
                            <a href="user-detail.php?id='.$item['id'].'"><button class="btn btn-info">Detail</button></a>
                          </td>
                          <td>
