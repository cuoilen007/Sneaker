                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="blog-area">
                                    ...
                                    // NOW() là hàm lấy ngày hiện tại của Mysql
                                    // đoạn dưới thể hiện chỉ lấy ra những event đã bắt đầu nhưng chưa kết thúc.
                                    ...
                                    // event.* là viết tắt của chọn tất cả các danh mục của bảng trong trường hợp join.
                                    ...
                                    //die($sql);
                                    //dem so trang
                                    $sql_page='SELECT COUNT(id) AS total FROM event WHERE 1'.$sort_search;//thêm $sort_search để auto chia page đúng trong sort/search
